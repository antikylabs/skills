...
| [`general-anti-slop`](skills/general-anti-slop/) | Ready | Reject what looks like evidence and is not: tests that cannot fail, discarded errors, stubs, orphan scripts, claims with no referent. Ships a twenty-rule Oxlint plugin and two Node-only linters. |
