...
that is `general-simplified-technical-english`, invoked separately. Do not reach for it by default.
...
Where a repository has its own documentation conventions — where pages live, what is generated, what
vocabulary is banned — those belong to a `repo-` skill, not here. This skill is portable and says
