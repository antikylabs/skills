...
- work too big to hold in one change → `general-write-objectives`
- a page that is the wrong shape → `general-write-docs`
- prose that must meet the standard → `general-simplified-technical-english`
