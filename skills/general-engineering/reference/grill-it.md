...
- an undocumented decision → `general-write-adrs suggest`
- work too big for one change → `general-write-objectives`
- a document that is the wrong shape → `general-write-docs`
