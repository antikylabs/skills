---
name: general-simplified-technical-english
...
reports none, use `.claude/skills/general-simplified-technical-english/` or
`.agents/skills/general-simplified-technical-english/`. Keep cwd at the user's project.
