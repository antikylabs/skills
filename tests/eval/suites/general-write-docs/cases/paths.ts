...
export const POINT_LIGHT = fixture("general-write-docs", "point-light.md");

/** A tutorial that branches and explains — serving a first-timer and an expert. */
export const GETTING_STARTED = fixture("general-write-docs", "getting-started.md");

/** A clean how-to. Nothing wrong with it. */
export const CLEAN_HOWTO = fixture("general-write-docs", "change-light-at-runtime.md");
