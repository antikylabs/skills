...
export const ROADMAP = fixture("write-objectives", "roadmap.md");

/** A raw objective.md with intent but no research and no plan behind it yet. */
export const OBJECTIVE = fixture("write-objectives", "objective.md");

/** A simple (un-nested) goal folder, for the smaller-scale lifecycle. */
export const SIMPLE_GOAL = fixture("write-objectives", "goals/inspection-json-flag/goal.md");
