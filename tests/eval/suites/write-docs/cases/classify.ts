...
export const CLASSIFY_CASES: EvalCase[] = [
...

  {
    ...
    script: [
      tool("read_file", { path: `/skills/general/${SKILL}/reference/types.md` }),
      tool("read_file", { path: POINT_LIGHT }),
      text(
...

  {
    ...
    script: [
      tool("read_file", { path: `/skills/general/${SKILL}/reference/audit.md` }),
      tool("read_file", { path: POINT_LIGHT }),
      text(
...

  {
    ...
    script: [
      tool("read_file", { path: `/skills/general/${SKILL}/reference/split.md` }),
