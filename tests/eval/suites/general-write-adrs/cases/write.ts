...
export const WRITE_CASES: EvalCase[] = [
  {
    ...
    prompt:
      ...
      `/workspace/general-write-adrs — write the record.`,
    ...
    script: [
      ...
      tool("list_dir", { path: "/workspace/general-write-adrs" }),
      tool("write_file", {
        path: "/workspace/general-write-adrs/framework/0003-brometal-render-driver_H.md",
    ...
    negativeControl: {
      ...
      script: [
        tool("write_file", {
          path: "/workspace/general-write-adrs/framework/0022-brometal-render-driver_H.md",
