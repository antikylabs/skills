 ...
 */
export const MESSY = fixture("anti-slop", "messy-repo");

/** The same shapes done correctly. The checker says nothing — the clean-run trap. */
export const TIDY = fixture("anti-slop", "tidy-repo");

/** A document that reads confidently and asserts nothing checkable. */
export const OVERCLAIMING = fixture("anti-slop", "overclaiming.md");

/** A document that makes the same kind of claims and evidences them. */
export const MEASURED = fixture("anti-slop", "measured.md");
...
export const RULE_DATA = `/skills/general/${SKILL}/scripts/structure-lint.json`;
