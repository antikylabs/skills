...
export const UPDATE_CASES: EvalCase[] = [
  {
    ...
    script: [
      ...
      tool("read_file", { path: `/skills/general/${SKILL}/reference/update.md` }),
    ...
    negativeControl: {
      ...
      script: [
        tool("read_file", { path: UNRELEASED }),
        tool("move_file", { from: UNRELEASED, to: "/workspace/brometal-patching/.deleted.mjs" }),
...

  {
    ...
    script: [
      ...
      tool("move_file", { from: RETIRABLE, to: "/workspace/brometal-patching/.retired-render-target-filtering.mjs" }),
      tool("edit_file", {
        path: RUNNER,
    ...
    negativeControl: {
      ...
      script: [
        tool("move_file", { from: RETIRABLE, to: "/workspace/brometal-patching/.gone.mjs" }),
