...
export const UPDATE_CASES: EvalCase[] = [
  {
    ...
    negativeControl: {
      ...
      script: [
        tool("read_file", { path: UNRELEASED }),
        tool("move_file", { from: UNRELEASED, to: "/workspace/general-brometal-patching/.deleted.mjs" }),
...

  {
    ...
    script: [
      ...
      tool("move_file", { from: RETIRABLE, to: "/workspace/general-brometal-patching/.retired-render-target-filtering.mjs" }),
      tool("edit_file", {
        path: RUNNER,
    ...
    negativeControl: {
      ...
      script: [
        tool("move_file", { from: RETIRABLE, to: "/workspace/general-brometal-patching/.gone.mjs" }),
