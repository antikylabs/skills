/**
 * ADR trigger cases — routing for `team-write-adrs`.
 *
 ...
 * lands.
 *
 * The collision cases matter most. `team-write-adrs` and
 * `team-simplified-technical-english` both plausibly match "review this ADR",
