...
export const ROADMAP = fixture("objectives", "roadmap.md");

/** A raw objective.md with intent but no research and no plan behind it yet. */
export const OBJECTIVE = fixture("objectives", "objective.md");

/** A simple (un-nested) goal folder, for the smaller-scale lifecycle. */
export const SIMPLE_GOAL = fixture("objectives", "goals/inspection-json-flag/goal.md");
