...
- [Goal 00](_completed/execute-goal-00.md) and [Goal 01](execute-goal-01.md) are complete; `docs/pipelines/README.md`, `docs/pipelines/PIPELINE_TEMPLATE.md`, `docs/objectives/skill-process/research/05-scott-threejs-harvest.md`, and `06-thrixel-harvest.md` are available.
